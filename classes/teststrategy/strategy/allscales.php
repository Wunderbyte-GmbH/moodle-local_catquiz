...
use local_catquiz\teststrategy\preselect_task\strategyallscalesscore;
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class allscales extends strategy {

    /**
     *
     * @var int $id
     */
    public int $id = LOCAL_CATQUIZ_STRATEGY_ALLSCALES;

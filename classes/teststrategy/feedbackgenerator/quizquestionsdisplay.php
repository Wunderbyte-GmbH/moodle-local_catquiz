 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizquestionsdisplay extends feedbackgenerator {
    ...
    public function get_studentfeedback(array $data): array {
        global $OUTPUT;
        $feedback = $OUTPUT->render_from_template('local_catquiz/feedback/quizquestionsdisplay', $data);
    ...
    public function get_heading(): string {
        return get_string('quizquestionsdisplay', 'local_catquiz');
    }

...
$string['noparentsgiven'] = 'Scale {$a->catscalename} can not be localized, because there are no parent scales given. Record with componentid {$a->componentid} was not imported.';

...
$string['groupenrolementhelptext_help'] = 'Please enter exact name(s) of existing group like (i.e. "group1,group2" or "group3").';
$string['groupenrolementhelptext'] = 'Please enter exact name(s) of existing group like (i.e. "group1,group2" or "group3").';
...
$string['teststrategy'] = 'Teststrategy : {$a}';

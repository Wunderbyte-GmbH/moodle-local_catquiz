...
$string['central_scale'] = 'Scale to sync';
$string['central_scale_desc'] = 'TODO: autocomplate - now integer ID. Parameters of this scale will be synced with the compute instance';
...
$string['fetchempty'] = 'No parameters were synced';
...
$string['submission_success'] = '{$a} responses successfully submitted';

...
$string['calculation_skipped'] = 'Calculation was skipped.';
$string['calculationmanagement'] = 'Recalculation management';
$string['calculationmanagement_help'] = 'Start an incremental recalculation (keeps the current context) or a disruptive recalculation (creates a new context on success), and review the last run per scale.';
$string['calculationpending'] = 'Pending';
$string['calculationqueued'] = 'The recalculation has been queued as an ad-hoc task.';
...
$string['catmanagernumberofunusableitems'] = 'Items with unusable parameters';
$string['catmodelsettings'] = 'CAT-Model';
$string['catquiz'] = 'Catquiz';
$string['catquiz:canaccess'] = 'Take a CAT quiz attempt';
$string['catquiz:canmanage'] = 'Is allowed to manage Catquiz plugin';
$string['catquiz:disruptiverecalculate'] = 'Is allowed to start a disruptive recalculation (creates a new context)';
...
$string['catquiz:recalculate'] = 'Is allowed to start an incremental recalculation';
...
$string['central_token_desc'] = 'The token that was created for you on the compute instance';
$string['central_token_help'] = 'The token that was created for you on the compute instance';
...
$string['cleanupprogress'] = 'Clean up attempt progress';
$string['close'] = 'Close';
...
$string['copiedsubscalesettings'] = 'Values applied to {$a} subscale(s).';
$string['copyingsubscalesettings'] = 'Applying values to selected subscales...';
...
$string['csvimporterrors'] = 'Errors';
$string['csvimportgeneralerrors'] = 'General errors';
$string['csvimportmissingquestionlabeldetail'] = 'The following labels were not found in the question bank:';
$string['csvimportmissingquestionlabels'] = 'Missing question labels';
$string['csvimportremovedolderquestionversions'] = 'Removed older versions of question';
$string['csvimportwarnings'] = 'Warnings';
...
$string['disruptiveconfirm'] = 'A disruptive recalculation recomputes all parameters and, on success, creates and activates a new context. Do you want to queue it?';
...
$string['feedbacknovalidresult'] = 'No valid test result could be determined for this attempt.';
$string['feedbacknovalidresultheading'] = 'Test result';
...
$string['itemparams_noparams'] = 'No parameters (pilot item)';
$string['itemparams_unusable'] = 'Not usable (treated as pilot item)';
$string['itemparams_unusable_reason'] = 'Model "{$a->model}": {$a->reason}';
$string['itemparams_usable'] = 'Usable';
$string['itemparamvalidity'] = 'Parameter validity';
...
$string['labelidnotfound'] = 'Question label “{$a}” was not found in the question bank.';
...
$string['localcalculations'] = "Calculations for local data";
$string['localcalculationshelp'] = "Update local item parameters based on local response data";
...
$string['minpeersforcomparison_desc'] = 'Minimum number of distinct persons required before the peer comparison is shown. Small groups are suppressed in charts and exports alike.';
$string['minpeersforcomparison_name'] = 'Minimum peers for comparison';
...
$string['nomainscaleincontext'] = 'No root scale is assigned to the given context';
...
$string['noresponsestoestimate'] = 'Not enough responses to update parameters.';
$string['noresponsestoestimatedesc'] = '{$a->reason} Scale: {$a->scalename}, Context: {$a->contextname}.';
...
$string['nosubscalechosenforcopy'] = 'No child scale is available for copying.';
...
$string['parameterssynced'] = 'Parameters synced';
...
$string['privacy:metadata:local_catquiz_attempts:attemptid'] = 'The id of the attempt in the component the test was taken in.';
$string['privacy:metadata:local_catquiz_attempts:component'] = 'The component the attempt belongs to.';
$string['privacy:metadata:local_catquiz_attempts:contextid'] = 'The CAT context the attempt was taken in.';
$string['privacy:metadata:local_catquiz_attempts:courseid'] = 'The course the attempt belongs to.';
$string['privacy:metadata:local_catquiz_attempts:instanceid'] = 'The activity instance the attempt belongs to.';
$string['privacy:metadata:local_catquiz_attempts:scaleid'] = 'The CAT scale the attempt was taken for.';
$string['privacy:metadata:local_catquiz_attempts:status'] = 'The status of the attempt, for example running or completed.';
$string['privacy:metadata:local_catquiz_attempts:timecreated'] = 'The time the attempt was started.';
$string['privacy:metadata:local_catquiz_attempts:timemodified'] = 'The time the attempt was last changed.';
$string['privacy:metadata:local_catquiz_attempts:userid'] = 'The user the attempt belongs to.';
$string['privacy:metadata:local_catquiz_personparams'] = 'User parameter data in different contexts.';
$string['privacy:metadata:local_catquiz_personparams:ability'] = 'The estimated ability of the person on a CAT scale.';
$string['privacy:metadata:local_catquiz_personparams:attemptid'] = 'The attempt the estimate was produced in.';
$string['privacy:metadata:local_catquiz_personparams:catscaleid'] = 'The CAT scale the estimate belongs to.';
$string['privacy:metadata:local_catquiz_personparams:contextid'] = 'The CAT context the estimate belongs to.';
$string['privacy:metadata:local_catquiz_personparams:standarderror'] = 'The standard error of the estimated ability.';
$string['privacy:metadata:local_catquiz_personparams:timecreated'] = 'The time the estimate was stored.';
$string['privacy:metadata:local_catquiz_personparams:timemodified'] = 'The time the estimate was last changed.';
$string['privacy:metadata:local_catquiz_personparams:userid'] = 'The person the estimate belongs to.';
$string['privacy:metadata:local_catquiz_progress'] = 'The working state of an attempt: which questions were played, which scales are active, the given answers and the ability estimates. How long this is kept, and whether a step by step trace is recorded, is controlled by the retention setting.';
$string['privacy:metadata:local_catquiz_progress:attemptid'] = 'The attempt this working state belongs to.';
$string['privacy:metadata:local_catquiz_progress:component'] = 'The component the attempt belongs to.';
$string['privacy:metadata:local_catquiz_progress:id'] = 'The internal id of the record.';
$string['privacy:metadata:local_catquiz_progress:json'] = 'The stored working state, including the given answers and, in trace mode, the ability estimate of every step.';
$string['privacy:metadata:local_catquiz_progress:quizsettings'] = 'The quiz settings that applied while the attempt was running.';
$string['privacy:metadata:local_catquiz_progress:userid'] = 'The person the attempt belongs to.';
...
$string['progressretention'] = 'Retention of attempt progress';
$string['progressretention_default'] = 'Use the site default';
$string['progressretention_desc'] = 'Controls how long the working state of an attempt is kept, and how much of it. Minimal deletes it once the attempt is finished and keeps no answer data. Keep retains the final state per scale. Trace additionally records the ability estimate of every step, which is the most personal data of the three.';
$string['progressretention_help'] = 'Controls how long the working state of this test is kept. The site setting acts as an upper bound: options that would retain more than the site permits are not offered here.';
$string['progressretention_keep'] = 'Keep the final state';
$string['progressretention_minimal'] = 'Minimal - delete after the attempt';
$string['progressretention_trace'] = 'Record the step by step trace';
$string['progressretentiondays'] = 'Retention period in days';
$string['progressretentiondays_desc'] = 'Number of days after which recorded progress is removed by the scheduled task. Zero means unlimited.';
...
$string['questiontextsearch'] = 'Search in question texts';
$string['questiontextsearch_help'] = 'Searches inside the text of the questions. The question texts are deliberately not part of the list itself, so this search runs as a separate step.';
$string['questiontextsearch_toomany'] = 'The search term matches too many questions to filter the list. Please use a more specific term.';
...
$string['recalculationscheduled'] = 'Recalculation of the context parameters has been scheduled.<br>Updated parameters will be saved to a new context.';
$string['recentevents'] = 'Recent Events';
$string['relevantscales'] = 'Infer relevant subscales';
$string['remotecalcbutton'] = 'Recalculate from submitted responses';
$string['remotesubmitbutton'] = 'Submit responses to hub';
$string['removedolderquestionversionsfromscale'] = 'Removed older versions of question "{$a->label}" from scale "{$a->scale}".';
...
$string['statistics_month_01'] = 'January {$a->y}';
$string['statistics_month_02'] = 'February {$a->y}';
$string['statistics_month_03'] = 'March {$a->y}';
$string['statistics_month_04'] = 'April {$a->y}';
$string['statistics_month_05'] = 'May {$a->y}';
$string['statistics_month_06'] = 'June {$a->y}';
$string['statistics_month_07'] = 'July {$a->y}';
$string['statistics_month_08'] = 'August {$a->y}';
$string['statistics_month_09'] = 'September {$a->y}';
$string['statistics_month_10'] = 'October {$a->y}';
$string['statistics_month_11'] = 'November {$a->y}';
$string['statistics_month_12'] = 'December {$a->y}';
...
$string['subplugintype_catquizcentralhub'] = 'CAT quiz central hub plugin';
$string['subplugintype_catquizcentralhub_plural'] = 'CAT quiz central hub plugins';
...
$string['updatedparamscontextdesc'] = 'Automatically generated via updated of parameters for CAT scale {$a}.';

...
$string['noparentsgiven'] = 'Die Skala {$a->catscalename} ist nicht eindeutig lokalisierbar, weil keine übergeordneten Skalen angegeben wurden. Datensatz mit componentid {$a->componentid} daher nicht importiert/aktualisiert.';

...
$string['csvexportheader:useremail'] = 'UserE-Mail';
$string['csvexportheader:userid'] = 'UserID';
$string['csvexportheader:username'] = 'UserName';
...
$string['stringdate:month:01'] = 'Januar {$a->y}';
$string['stringdate:month:02'] = 'Februar {$a->y}';
$string['stringdate:month:03'] = 'März {$a->y}';
$string['stringdate:month:04'] = 'April {$a->y}';
$string['stringdate:month:05'] = 'Mai {$a->y}';
$string['stringdate:month:06'] = 'Juni {$a->y}';
$string['stringdate:month:07'] = 'Juli {$a->y}';
$string['stringdate:month:08'] = 'August {$a->y}';
$string['stringdate:month:09'] = 'September {$a->y}';
$string['stringdate:month:10'] = 'Oktober {$a->y}';
$string['stringdate:month:11'] = 'November {$a->y}';
$string['stringdate:month:12'] = 'Dezember {$a->y}';

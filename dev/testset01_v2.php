...
$responses = model_responses::create_from_array($demoresponse);

$raschpl1 = new \catmodel_raschbirnbauma\raschbirnbauma($responses, "RaschBB_1PL");
...
$initialpersonabilities = $responses->get_initial_person_abilities();

$itemresponse = $responses->get_item_response($initialpersonabilities);

$synthitemresponse = \local_catquiz\synthcat::get_item_response2(80, 120, 0.2);

$x = \local_catquiz\catcalc::estimate_item_params($synthitemresponse, $raschpl1);

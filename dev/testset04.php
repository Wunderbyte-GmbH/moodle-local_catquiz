...
$demoresponse = local_catquiz\synthcat::generate_response_multi($demopersons, $demoitems, $raschbb); // just for creating some responses
...
$synthitemresponse = \local_catquiz\synthcat::get_item_response2(40, 60, 0.0);


// $x = \local_catquiz\catcalc::estimate_item_params($synth_item_response,$raschbb);


// estimate item parameter with 1 PL

// $start = [0.2];
// $model_1pl = new \catmodel_raschbirnbauma\raschbirnbauma($responses,"RaschBB_1PL");
...
//
// $start = [1, 3];
// $model_2pl = new \catmodel_raschbirnbaumb\raschbirnbaumb($responses,"RaschBB_2PL");
...
$start = [1, 3, 0.2];
$model3pl = new \catmodel_raschbirnbaumc\raschbirnbaumc($responses, "RaschBB_3PL");
$paramsmodel3pl = \local_catquiz\catcalc::estimate_item_params($synthitemresponse, $model3pl, $start);

...
$demoitems = local_catquiz\synthcat::generate_test_items_multi([$demoitemdiscriminations, $demoitemdifficulties]);

$response = new model_responses();
$raschbb = new \catmodel_raschbirnbaumb\raschbirnbaumb($response, "RaschBB_2PL");
